...
namespace Library.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260913164458_AddLoansAndFines")]
    partial class AddLoansAndFines
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Library.Domain.Entities.Fine", b =>
                {
                    ...
                    b.HasIndex("MemberId", "PaidAt", "WaivedAt")
            ...
            modelBuilder.Entity("Library.Domain.Entities.Fine", b =>
                {
                    b.HasOne("Library.Domain.Entities.Loan", "Loan")
                        .WithOne("Fine")
                        .HasForeignKey("Library.Domain.Entities.Fine", "LoanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
